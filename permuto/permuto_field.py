...
class PermutoField(Field):
    ...
    def __init__(
        ...
        #             "n_levels": config.num_levels,  # 16
        #             "n_features_per_level": config.features_per_level, # 2
        #             "log2_hashmap_size": config.log2_hashmap_size, # 19
        #             "base_resolution": config.base_res, # 16
